...
public class HyperloopProxy extends TiViewProxy implements InvocationHandler {
    ...
    public void handleCreationDict(KrollDict options) {
        ...
        try {
            ...
            if (this.clazz.isInterface()) {
                ...
                overrides = (HashMap<String, Object>) args[0];
            } else {
                ...
                if (alloc) {
                    ...
                    Object[] convertedArgs = unwrapArguments(initArgs);
                    ...
                    if (convertedArgs.length == 1 && convertedArgs[0] != null
                        ...
                        Object instance = cons.newInstance(convert(convertedArgs, cons.getParameterTypes()));
    ...
    private Object[] convert(Object[] arguments, Class<?>[] parameterTypes) {
        if (arguments == null) {
            return null;
        }
    ...
    public void setNativeObject(Object nativeObject) {
        Object converted = unwrap(nativeObject);
    ...
    private Object invokeMethod(String methodName, Object[] args,
            boolean instanceMethod) {
        Object[] convertedArgs = unwrapArguments(args);
        Object receiver;
        Class<?> c;
        ...
        m.setAccessible(true); // should offer perf boost since doesn't have to
                               // check security
        try {
            return m.invoke(receiver, convert(convertedArgs, m.getParameterTypes()));
        } catch (IllegalAccessException e) {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if (value instanceof KrollFunction) {
            ...
            return unwrap(kf.call(getKrollObject(), wrapArguments(args)));
        }
