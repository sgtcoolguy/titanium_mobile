 ...
 **/
android.text.method.MovementMethod = function() {
	var result;
...
android.text.method.MovementMethod.toString = function() {
	return "[object " + this.className + "]";
};

android.text.method.MovementMethod.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.text.method.MovementMethod.isInstanceOf = function (self, cls) {
...
module.exports = android.text.method.MovementMethod;
