 ...
 **/
java.net.Proxy = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.net.Proxy') {
		result = arguments[0];
	}
	else {
...
java.net.Proxy.prototype = Object.create(SuperClass.prototype);
java.net.Proxy.prototype.constructor = java.net.Proxy;

java.net.Proxy.className = "java.net.Proxy";
java.net.Proxy.prototype.className = "java.net.Proxy";

// Constants

// Static fields
// http://developer.android.com/reference/java/net/Proxy.html#NO_PROXY
Object.defineProperty(java.net.Proxy, 'NO_PROXY', {
	get: function() {
		...
		if (result.apiName) {
			if (result.apiName === 'java.net.Proxy') {
				return new java.net.Proxy(result);
			} else {
 ...
 **/
java.net.Proxy.prototype.address = function() {
 ...
 **/
java.net.Proxy.prototype.hashCode = function() {
	if (!this._hasPointer) return null;
 ...
 **/
java.net.Proxy.prototype.equals = function() {
	if (!this._hasPointer) return null;
 ...
 **/
java.net.Proxy.prototype.toString = function() {
	if (!this._hasPointer) return null;
 ...
 **/
java.net.Proxy.prototype.type = function() {
	if (!this._hasPointer) return null;
