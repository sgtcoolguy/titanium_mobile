 ...
 **/
android.database.sqlite.SQLiteCursorDriver = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.database.sqlite.SQLiteCursorDriver') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.database.sqlite.SQLiteCursorDriver.toString = function() {
	return "[object " + this.className + "]";
};

android.database.sqlite.SQLiteCursorDriver.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.database.sqlite.SQLiteCursorDriver.isInstanceOf = function (self, cls) {
...
android.database.sqlite.SQLiteCursorDriver.className = "android.database.sqlite.SQLiteCursorDriver";
android.database.sqlite.SQLiteCursorDriver.prototype.className = "android.database.sqlite.SQLiteCursorDriver";

// Constants

// export the interface
module.exports = android.database.sqlite.SQLiteCursorDriver;
