...
android.graphics.Paint.FontMetrics = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.graphics.Paint$FontMetrics') {
...
// class property
Object.defineProperty(android.graphics.Paint.FontMetrics, 'class', {
	get: function() {
...
// Allow subclassing
android.graphics.Paint.FontMetrics.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.graphics.Paint.FontMetrics.prototype);
