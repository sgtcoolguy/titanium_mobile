...
android.app.Application = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.app.Application') {
...
// class property
Object.defineProperty(android.app.Application, 'class', {
	get: function() {
...
// Allow subclassing
android.app.Application.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.app.Application.prototype);
