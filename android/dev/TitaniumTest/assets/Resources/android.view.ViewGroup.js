...
android.view.ViewGroup = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.view.ViewGroup') {
...
// class property
Object.defineProperty(android.view.ViewGroup, 'class', {
	get: function() {
...
// Allow subclassing
android.view.ViewGroup.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.view.ViewGroup.prototype);
...
android.view.ViewGroup.getChildMeasureSpec = function() {
	...
	if (result.apiName) {
		if (result.apiName === 'android.view.ViewGroup') {
			return new android.view.ViewGroup(result);
		} else {
