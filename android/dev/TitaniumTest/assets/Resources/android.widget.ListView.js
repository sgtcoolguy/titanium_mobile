...
android.widget.ListView = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.widget.ListView') {
...
// class property
Object.defineProperty(android.widget.ListView, 'class', {
	get: function() {
...
// Allow subclassing
android.widget.ListView.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.widget.ListView.prototype);
