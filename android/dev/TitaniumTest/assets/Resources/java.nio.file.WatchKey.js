 ...
 **/
java.nio.file.WatchKey = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.nio.file.WatchKey') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.nio.file.WatchKey.toString = function() {
	return "[object " + this.className + "]";
};

java.nio.file.WatchKey.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.nio.file.WatchKey.isInstanceOf = function (self, cls) {
...
java.nio.file.WatchKey.className = "java.nio.file.WatchKey";
java.nio.file.WatchKey.prototype.className = "java.nio.file.WatchKey";

// Constants

// export the interface
module.exports = java.nio.file.WatchKey;
