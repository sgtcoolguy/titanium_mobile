 ...
 **/
android.animation.Animator.AnimatorPauseListener = function() {
	var result;
...
android.animation.Animator.AnimatorPauseListener.toString = function() {
	return "[object " + this.className + "]";
};

android.animation.Animator.AnimatorPauseListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.animation.Animator.AnimatorPauseListener.isInstanceOf = function (self, cls) {
...
module.exports = android.animation.Animator.AnimatorPauseListener;
