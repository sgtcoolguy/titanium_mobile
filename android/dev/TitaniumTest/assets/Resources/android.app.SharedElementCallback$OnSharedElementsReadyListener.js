...
global.android.app.SharedElementCallback = global.android.app.SharedElementCallback || {};

/**
 * constructor
 * http://developer.android.com/reference/android/app/SharedElementCallback.OnSharedElementsReadyListener.html
 **/
android.app.SharedElementCallback.OnSharedElementsReadyListener = function() {
	var result;
...
android.app.SharedElementCallback.OnSharedElementsReadyListener.toString = function() {
	return "[object " + this.className + "]";
};

android.app.SharedElementCallback.OnSharedElementsReadyListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.app.SharedElementCallback.OnSharedElementsReadyListener.isInstanceOf = function (self, cls) {
...
module.exports = android.app.SharedElementCallback.OnSharedElementsReadyListener;
