 ...
 **/
android.view.inputmethod.InputConnection = function() {
	var result;
...
android.view.inputmethod.InputConnection.toString = function() {
	return "[object " + this.className + "]";
};

android.view.inputmethod.InputConnection.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.inputmethod.InputConnection.isInstanceOf = function (self, cls) {
...
android.view.inputmethod.InputConnection.GET_EXTRACTED_TEXT_MONITOR = 1;
// http://developer.android.com/reference/android/view/inputmethod/InputConnection.html#CURSOR_UPDATE_MONITOR
android.view.inputmethod.InputConnection.CURSOR_UPDATE_MONITOR = 2;
// http://developer.android.com/reference/android/view/inputmethod/InputConnection.html#CURSOR_UPDATE_IMMEDIATE
android.view.inputmethod.InputConnection.CURSOR_UPDATE_IMMEDIATE = 1;
// http://developer.android.com/reference/android/view/inputmethod/InputConnection.html#GET_TEXT_WITH_STYLES
android.view.inputmethod.InputConnection.GET_TEXT_WITH_STYLES = 1;

// export the interface
module.exports = android.view.inputmethod.InputConnection;
