...
android.view.DragEvent = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.view.DragEvent') {
...
// class property
Object.defineProperty(android.view.DragEvent, 'class', {
	get: function() {
...
// Allow subclassing
android.view.DragEvent.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.view.DragEvent.prototype);
