...
android.util.SizeF.prototype = Object.create(SuperClass.prototype);
android.util.SizeF.prototype.constructor = android.util.SizeF;
...
android.util.SizeF.parseSizeF = function() {
	...
	if (result.apiName) {
		if (result.apiName === 'android.util.SizeF') {
			return new android.util.SizeF(result);
		} else {
 ...
 **/
android.util.SizeF.prototype.getHeight = function() {
 ...
 **/
android.util.SizeF.prototype.hashCode = function() {
	if (!this._hasPointer) return null;
 ...
 **/
android.util.SizeF.prototype.equals = function() {
	if (!this._hasPointer) return null;
 ...
 **/
android.util.SizeF.prototype.toString = function() {
	if (!this._hasPointer) return null;
 ...
 **/
android.util.SizeF.prototype.getWidth = function() {
	if (!this._hasPointer) return null;
...
// export the class
module.exports = android.util.SizeF;
