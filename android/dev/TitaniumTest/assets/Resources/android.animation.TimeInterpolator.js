 ...
 **/
android.animation.TimeInterpolator = function() {
	var result;
...
android.animation.TimeInterpolator.toString = function() {
	return "[object " + this.className + "]";
};

android.animation.TimeInterpolator.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.animation.TimeInterpolator.isInstanceOf = function (self, cls) {
...
module.exports = android.animation.TimeInterpolator;
