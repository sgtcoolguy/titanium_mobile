 ...
 **/
android.view.WindowId = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.view.WindowId') {
		result = arguments[0];
	}
	else {
...
android.view.WindowId.prototype = Object.create(SuperClass.prototype);
android.view.WindowId.prototype.constructor = android.view.WindowId;

android.view.WindowId.className = "android.view.WindowId";
android.view.WindowId.prototype.className = "android.view.WindowId";

// Constants

// Static fields
// http://developer.android.com/reference/android/view/WindowId.html#CREATOR
Object.defineProperty(android.view.WindowId, 'CREATOR', {
	get: function() {
		...
		if (result.apiName) {
			if (result.apiName === 'android.view.WindowId') {
				return new android.view.WindowId(result);
			} else {
 ...
 **/
android.view.WindowId.prototype.unregisterFocusObserver = function() {
 ...
 **/
android.view.WindowId.prototype.hashCode = function() {
	if (!this._hasPointer) return null;
 ...
 **/
android.view.WindowId.prototype.equals = function() {
	if (!this._hasPointer) return null;
 ...
 **/
android.view.WindowId.prototype.registerFocusObserver = function() {
	if (!this._hasPointer) return null;
 ...
 **/
android.view.WindowId.prototype.toString = function() {
	if (!this._hasPointer) return null;
 ...
 **/
android.view.WindowId.prototype.isFocused = function() {
	if (!this._hasPointer) return null;
 ...
 **/
android.view.WindowId.prototype.describeContents = function() {
	if (!this._hasPointer) return null;
 ...
 **/
android.view.WindowId.prototype.writeToParcel = function() {
	if (!this._hasPointer) return null;
...
// export the class
module.exports = android.view.WindowId;
