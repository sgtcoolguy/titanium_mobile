 ...
 **/
android.view.ViewTreeObserver.OnGlobalLayoutListener = function() {
	var result;
...
android.view.ViewTreeObserver.OnGlobalLayoutListener.toString = function() {
	return "[object " + this.className + "]";
};

android.view.ViewTreeObserver.OnGlobalLayoutListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.ViewTreeObserver.OnGlobalLayoutListener.isInstanceOf = function (self, cls) {
...
module.exports = android.view.ViewTreeObserver.OnGlobalLayoutListener;
