 ...
 **/
java.util.function.ToLongFunction = function() {
	var result;
...
java.util.function.ToLongFunction.toString = function() {
	return "[object " + this.className + "]";
};

java.util.function.ToLongFunction.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.function.ToLongFunction.isInstanceOf = function (self, cls) {
...
module.exports = java.util.function.ToLongFunction;
