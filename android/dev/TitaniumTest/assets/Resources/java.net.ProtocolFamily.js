 ...
 **/
java.net.ProtocolFamily = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.net.ProtocolFamily') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.net.ProtocolFamily.toString = function() {
	return "[object " + this.className + "]";
};

java.net.ProtocolFamily.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.net.ProtocolFamily.isInstanceOf = function (self, cls) {
...
java.net.ProtocolFamily.className = "java.net.ProtocolFamily";
java.net.ProtocolFamily.prototype.className = "java.net.ProtocolFamily";

// Constants

// export the interface
module.exports = java.net.ProtocolFamily;
