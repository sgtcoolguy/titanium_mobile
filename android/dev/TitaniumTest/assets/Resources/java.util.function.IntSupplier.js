 ...
 **/
java.util.function.IntSupplier = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.function.IntSupplier') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.function.IntSupplier.toString = function() {
	return "[object " + this.className + "]";
};

java.util.function.IntSupplier.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.function.IntSupplier.isInstanceOf = function (self, cls) {
...
java.util.function.IntSupplier.className = "java.util.function.IntSupplier";
java.util.function.IntSupplier.prototype.className = "java.util.function.IntSupplier";

// Constants

// export the interface
module.exports = java.util.function.IntSupplier;
