 ...
 **/
java.lang.reflect.AnnotatedType = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.lang.reflect.AnnotatedType') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.lang.reflect.AnnotatedType.toString = function() {
	return "[object " + this.className + "]";
};

java.lang.reflect.AnnotatedType.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.lang.reflect.AnnotatedType.isInstanceOf = function (self, cls) {
...
java.lang.reflect.AnnotatedType.className = "java.lang.reflect.AnnotatedType";
java.lang.reflect.AnnotatedType.prototype.className = "java.lang.reflect.AnnotatedType";

// Constants

// export the interface
module.exports = java.lang.reflect.AnnotatedType;
