 ...
 **/
java.nio.channels.WritableByteChannel = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.nio.channels.WritableByteChannel') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.nio.channels.WritableByteChannel.toString = function() {
	return "[object " + this.className + "]";
};

java.nio.channels.WritableByteChannel.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.nio.channels.WritableByteChannel.isInstanceOf = function (self, cls) {
...
java.nio.channels.WritableByteChannel.className = "java.nio.channels.WritableByteChannel";
java.nio.channels.WritableByteChannel.prototype.className = "java.nio.channels.WritableByteChannel";

// Constants

// export the interface
module.exports = java.nio.channels.WritableByteChannel;
