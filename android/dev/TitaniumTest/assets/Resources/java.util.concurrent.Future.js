 ...
 **/
java.util.concurrent.Future = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.concurrent.Future') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.concurrent.Future.toString = function() {
	return "[object " + this.className + "]";
};

java.util.concurrent.Future.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.concurrent.Future.isInstanceOf = function (self, cls) {
...
java.util.concurrent.Future.className = "java.util.concurrent.Future";
java.util.concurrent.Future.prototype.className = "java.util.concurrent.Future";

// Constants

// export the interface
module.exports = java.util.concurrent.Future;
