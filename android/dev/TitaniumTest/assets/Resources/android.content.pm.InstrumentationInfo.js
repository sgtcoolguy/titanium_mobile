...
android.content.pm.InstrumentationInfo = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.content.pm.InstrumentationInfo') {
...
// class property
Object.defineProperty(android.content.pm.InstrumentationInfo, 'class', {
	get: function() {
...
// Allow subclassing
android.content.pm.InstrumentationInfo.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.content.pm.InstrumentationInfo.prototype);
