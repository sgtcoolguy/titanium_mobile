...
global.android.view.Window = global.android.view.Window || {};

/**
 * constructor
 * http://developer.android.com/reference/android/view/Window.Callback.html
 **/
android.view.Window.Callback = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.view.Window$Callback') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.view.Window.Callback.toString = function() {
	return "[object " + this.className + "]";
};

android.view.Window.Callback.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.Window.Callback.isInstanceOf = function (self, cls) {
...
android.view.Window.Callback.className = "android.view.Window$Callback";
android.view.Window.Callback.prototype.className = "android.view.Window$Callback";

// Constants

// export the interface
module.exports = android.view.Window.Callback;
