 ...
 **/
java.nio.channels.SeekableByteChannel = function() {
	var result;
...
java.nio.channels.SeekableByteChannel.toString = function() {
	return "[object " + this.className + "]";
};

java.nio.channels.SeekableByteChannel.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.nio.channels.SeekableByteChannel.isInstanceOf = function (self, cls) {
...
module.exports = java.nio.channels.SeekableByteChannel;
