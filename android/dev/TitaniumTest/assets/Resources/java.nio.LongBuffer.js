...
java.nio.LongBuffer = function() {
	...
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.nio.LongBuffer') {
		result = arguments[0];
	}
	else {
...
// Instance Fields
// http://developer.android.com/reference/java/nio/LongBuffer.html#isReadOnly
Object.defineProperty(java.nio.LongBuffer.prototype, 'isReadOnly', {
	get: function() {
...
// http://developer.android.com/reference/java/nio/LongBuffer.html#offset
Object.defineProperty(java.nio.LongBuffer.prototype, 'offset', {
	get: function() {
		if (!this._hasPointer) return null;
...
// http://developer.android.com/reference/java/nio/LongBuffer.html#hb
Object.defineProperty(java.nio.LongBuffer.prototype, 'hb', {
	get: function() {
		if (!this._hasPointer) return null;
