...
java.util.stream.Stream = function() {
	...
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.stream.Stream') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.stream.Stream.toString = function() {
	return "[object " + this.className + "]";
};

java.util.stream.Stream.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.stream.Stream.isInstanceOf = function (self, cls) {
...
java.util.stream.Stream.className = "java.util.stream.Stream";
java.util.stream.Stream.prototype.className = "java.util.stream.Stream";

// Constants

// export the interface
module.exports = java.util.stream.Stream;
