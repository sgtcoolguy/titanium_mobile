 ...
 **/
android.content.SharedPreferences.Editor = function() {
	var result;
...
android.content.SharedPreferences.Editor.toString = function() {
	return "[object " + this.className + "]";
};

android.content.SharedPreferences.Editor.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.content.SharedPreferences.Editor.isInstanceOf = function (self, cls) {
...
module.exports = android.content.SharedPreferences.Editor;
