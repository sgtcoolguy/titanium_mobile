 ...
 **/
android.view.MenuItem.OnMenuItemClickListener = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.view.MenuItem$OnMenuItemClickListener') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.view.MenuItem.OnMenuItemClickListener.toString = function() {
	return "[object " + this.className + "]";
};

android.view.MenuItem.OnMenuItemClickListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.MenuItem.OnMenuItemClickListener.isInstanceOf = function (self, cls) {
...
android.view.MenuItem.OnMenuItemClickListener.className = "android.view.MenuItem$OnMenuItemClickListener";
android.view.MenuItem.OnMenuItemClickListener.prototype.className = "android.view.MenuItem$OnMenuItemClickListener";

// Constants

// export the interface
module.exports = android.view.MenuItem.OnMenuItemClickListener;
