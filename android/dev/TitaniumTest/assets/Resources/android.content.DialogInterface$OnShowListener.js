 ...
 **/
android.content.DialogInterface.OnShowListener = function() {
	var result;
...
android.content.DialogInterface.OnShowListener.toString = function() {
	return "[object " + this.className + "]";
};

android.content.DialogInterface.OnShowListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.content.DialogInterface.OnShowListener.isInstanceOf = function (self, cls) {
...
module.exports = android.content.DialogInterface.OnShowListener;
