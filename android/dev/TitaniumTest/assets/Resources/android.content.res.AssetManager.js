...
android.content.res.AssetManager = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.content.res.AssetManager') {
...
// class property
Object.defineProperty(android.content.res.AssetManager, 'class', {
	get: function() {
