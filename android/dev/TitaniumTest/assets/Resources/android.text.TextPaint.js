...
android.text.TextPaint = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.text.TextPaint') {
...
// class property
Object.defineProperty(android.text.TextPaint, 'class', {
	get: function() {
...
// Allow subclassing
android.text.TextPaint.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.text.TextPaint.prototype);
