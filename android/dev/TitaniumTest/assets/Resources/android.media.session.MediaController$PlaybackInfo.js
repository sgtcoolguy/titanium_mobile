...
android.media.session.MediaController.PlaybackInfo = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.media.session.MediaController$PlaybackInfo') {
...
// class property
Object.defineProperty(android.media.session.MediaController.PlaybackInfo, 'class', {
	get: function() {
