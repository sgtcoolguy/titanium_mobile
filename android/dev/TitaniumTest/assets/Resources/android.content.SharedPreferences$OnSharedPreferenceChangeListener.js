...
global.android.content.SharedPreferences = global.android.content.SharedPreferences || {};

/**
 * constructor
 * http://developer.android.com/reference/android/content/SharedPreferences.OnSharedPreferenceChangeListener.html
 **/
android.content.SharedPreferences.OnSharedPreferenceChangeListener = function() {
	var result;
...
android.content.SharedPreferences.OnSharedPreferenceChangeListener.toString = function() {
	return "[object " + this.className + "]";
};

android.content.SharedPreferences.OnSharedPreferenceChangeListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.content.SharedPreferences.OnSharedPreferenceChangeListener.isInstanceOf = function (self, cls) {
...
module.exports = android.content.SharedPreferences.OnSharedPreferenceChangeListener;
