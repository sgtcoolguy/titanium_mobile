...
android.content.res.AssetFileDescriptor = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.content.res.AssetFileDescriptor') {
...
// class property
Object.defineProperty(android.content.res.AssetFileDescriptor, 'class', {
	get: function() {
...
// Allow subclassing
android.content.res.AssetFileDescriptor.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.content.res.AssetFileDescriptor.prototype);
