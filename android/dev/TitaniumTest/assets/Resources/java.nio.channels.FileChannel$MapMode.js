...
java.nio.channels.FileChannel.MapMode = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'java.nio.channels.FileChannel$MapMode') {
...
// class property
Object.defineProperty(java.nio.channels.FileChannel.MapMode, 'class', {
	get: function() {
...
// Allow subclassing
java.nio.channels.FileChannel.MapMode.extend = function (overrides) {
	...
	whatever.prototype = Object.create(java.nio.channels.FileChannel.MapMode.prototype);
