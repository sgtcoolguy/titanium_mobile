 ...
 **/
android.text.Editable = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.text.Editable') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.text.Editable.toString = function() {
	return "[object " + this.className + "]";
};

android.text.Editable.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.text.Editable.isInstanceOf = function (self, cls) {
...
android.text.Editable.className = "android.text.Editable";
android.text.Editable.prototype.className = "android.text.Editable";

// class property
Object.defineProperty(android.text.Editable, 'class', {
	get: function() {
...
module.exports = android.text.Editable;
