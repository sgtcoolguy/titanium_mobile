 ...
 **/
java.net.FileNameMap = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.net.FileNameMap') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.net.FileNameMap.toString = function() {
	return "[object " + this.className + "]";
};

java.net.FileNameMap.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.net.FileNameMap.isInstanceOf = function (self, cls) {
...
java.net.FileNameMap.className = "java.net.FileNameMap";
java.net.FileNameMap.prototype.className = "java.net.FileNameMap";

// Constants

// export the interface
module.exports = java.net.FileNameMap;
