 ...
 **/
android.database.DatabaseErrorHandler = function() {
	var result;
...
android.database.DatabaseErrorHandler.toString = function() {
	return "[object " + this.className + "]";
};

android.database.DatabaseErrorHandler.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.database.DatabaseErrorHandler.isInstanceOf = function (self, cls) {
...
module.exports = android.database.DatabaseErrorHandler;
