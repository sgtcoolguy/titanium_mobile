 ...
 **/
java.net.URLStreamHandlerFactory = function() {
	var result;
...
java.net.URLStreamHandlerFactory.toString = function() {
	return "[object " + this.className + "]";
};

java.net.URLStreamHandlerFactory.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.net.URLStreamHandlerFactory.isInstanceOf = function (self, cls) {
...
module.exports = java.net.URLStreamHandlerFactory;
