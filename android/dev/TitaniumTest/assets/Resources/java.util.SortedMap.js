...
java.util.SortedMap.toString = function() {
	return "[object " + this.className + "]";
};

java.util.SortedMap.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.SortedMap.isInstanceOf = function (self, cls) {
...
module.exports = java.util.SortedMap;
