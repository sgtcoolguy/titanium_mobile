 ...
 **/
android.view.animation.Interpolator = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.view.animation.Interpolator') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.view.animation.Interpolator.toString = function() {
	return "[object " + this.className + "]";
};

android.view.animation.Interpolator.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.animation.Interpolator.isInstanceOf = function (self, cls) {
...
android.view.animation.Interpolator.className = "android.view.animation.Interpolator";
android.view.animation.Interpolator.prototype.className = "android.view.animation.Interpolator";

// Constants

// export the interface
module.exports = android.view.animation.Interpolator;
