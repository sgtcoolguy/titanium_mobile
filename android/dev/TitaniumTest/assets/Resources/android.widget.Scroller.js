...
android.widget.Scroller = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.widget.Scroller') {
...
// class property
Object.defineProperty(android.widget.Scroller, 'class', {
	get: function() {
...
// Allow subclassing
android.widget.Scroller.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.widget.Scroller.prototype);
