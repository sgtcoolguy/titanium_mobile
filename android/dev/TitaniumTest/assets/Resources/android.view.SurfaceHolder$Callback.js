 ...
 **/
android.view.SurfaceHolder.Callback = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.view.SurfaceHolder$Callback') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.view.SurfaceHolder.Callback.toString = function() {
	return "[object " + this.className + "]";
};

android.view.SurfaceHolder.Callback.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.SurfaceHolder.Callback.isInstanceOf = function (self, cls) {
...
android.view.SurfaceHolder.Callback.className = "android.view.SurfaceHolder$Callback";
android.view.SurfaceHolder.Callback.prototype.className = "android.view.SurfaceHolder$Callback";

// Constants

// export the interface
module.exports = android.view.SurfaceHolder.Callback;
