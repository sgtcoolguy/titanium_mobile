 ...
 **/
android.widget.AdapterView.OnItemLongClickListener = function() {
	var result;
...
android.widget.AdapterView.OnItemLongClickListener.toString = function() {
	return "[object " + this.className + "]";
};

android.widget.AdapterView.OnItemLongClickListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.widget.AdapterView.OnItemLongClickListener.isInstanceOf = function (self, cls) {
...
module.exports = android.widget.AdapterView.OnItemLongClickListener;
