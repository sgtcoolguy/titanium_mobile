 ...
 **/
android.content.DialogInterface.OnCancelListener = function() {
	var result;
...
android.content.DialogInterface.OnCancelListener.toString = function() {
	return "[object " + this.className + "]";
};

android.content.DialogInterface.OnCancelListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.content.DialogInterface.OnCancelListener.isInstanceOf = function (self, cls) {
...
module.exports = android.content.DialogInterface.OnCancelListener;
