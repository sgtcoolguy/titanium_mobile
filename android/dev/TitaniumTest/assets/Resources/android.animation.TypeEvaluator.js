 ...
 **/
android.animation.TypeEvaluator = function() {
	var result;
...
android.animation.TypeEvaluator.toString = function() {
	return "[object " + this.className + "]";
};

android.animation.TypeEvaluator.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.animation.TypeEvaluator.isInstanceOf = function (self, cls) {
...
module.exports = android.animation.TypeEvaluator;
