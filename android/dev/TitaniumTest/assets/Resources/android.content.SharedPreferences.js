 ...
 **/
android.content.SharedPreferences = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.content.SharedPreferences') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.content.SharedPreferences.toString = function() {
	return "[object " + this.className + "]";
};

android.content.SharedPreferences.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.content.SharedPreferences.isInstanceOf = function (self, cls) {
...
android.content.SharedPreferences.className = "android.content.SharedPreferences";
android.content.SharedPreferences.prototype.className = "android.content.SharedPreferences";

// Constants

// export the interface
module.exports = android.content.SharedPreferences;
