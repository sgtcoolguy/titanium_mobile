...
java.util.function.IntToDoubleFunction.toString = function() {
	return "[object " + this.className + "]";
};

java.util.function.IntToDoubleFunction.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.function.IntToDoubleFunction.isInstanceOf = function (self, cls) {
...
module.exports = java.util.function.IntToDoubleFunction;
