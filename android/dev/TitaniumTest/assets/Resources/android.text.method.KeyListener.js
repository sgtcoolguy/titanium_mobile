 ...
 **/
android.text.method.KeyListener = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.text.method.KeyListener') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.text.method.KeyListener.toString = function() {
	return "[object " + this.className + "]";
};

android.text.method.KeyListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.text.method.KeyListener.isInstanceOf = function (self, cls) {
...
android.text.method.KeyListener.className = "android.text.method.KeyListener";
android.text.method.KeyListener.prototype.className = "android.text.method.KeyListener";

// class property
Object.defineProperty(android.text.method.KeyListener, 'class', {
	get: function() {
...
module.exports = android.text.method.KeyListener;
