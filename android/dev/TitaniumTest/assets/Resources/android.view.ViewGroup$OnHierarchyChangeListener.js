 ...
 **/
android.view.ViewGroup.OnHierarchyChangeListener = function() {
	var result;
...
android.view.ViewGroup.OnHierarchyChangeListener.toString = function() {
	return "[object " + this.className + "]";
};

android.view.ViewGroup.OnHierarchyChangeListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.ViewGroup.OnHierarchyChangeListener.isInstanceOf = function (self, cls) {
...
module.exports = android.view.ViewGroup.OnHierarchyChangeListener;
