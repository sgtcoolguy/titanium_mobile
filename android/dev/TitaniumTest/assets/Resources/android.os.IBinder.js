...
android.os.IBinder.toString = function() {
	return "[object " + this.className + "]";
};

android.os.IBinder.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.os.IBinder.isInstanceOf = function (self, cls) {
...
android.os.IBinder.PING_TRANSACTION = 1599098439;
