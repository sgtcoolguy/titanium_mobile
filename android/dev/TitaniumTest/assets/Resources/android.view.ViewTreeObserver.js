...
android.view.ViewTreeObserver = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.view.ViewTreeObserver') {
...
// class property
Object.defineProperty(android.view.ViewTreeObserver, 'class', {
	get: function() {
