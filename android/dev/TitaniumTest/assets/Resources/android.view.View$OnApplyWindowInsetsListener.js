 ...
 **/
android.view.View.OnApplyWindowInsetsListener = function() {
	var result;
...
android.view.View.OnApplyWindowInsetsListener.toString = function() {
	return "[object " + this.className + "]";
};

android.view.View.OnApplyWindowInsetsListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.View.OnApplyWindowInsetsListener.isInstanceOf = function (self, cls) {
...
module.exports = android.view.View.OnApplyWindowInsetsListener;
