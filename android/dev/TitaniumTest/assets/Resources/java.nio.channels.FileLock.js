...
java.nio.channels.FileLock = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'java.nio.channels.FileLock') {
...
// class property
Object.defineProperty(java.nio.channels.FileLock, 'class', {
	get: function() {
...
// Allow subclassing
java.nio.channels.FileLock.extend = function (overrides) {
	...
	whatever.prototype = Object.create(java.nio.channels.FileLock.prototype);
