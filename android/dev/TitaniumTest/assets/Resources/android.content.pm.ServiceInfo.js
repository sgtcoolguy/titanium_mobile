...
android.content.pm.ServiceInfo = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.content.pm.ServiceInfo') {
...
// class property
Object.defineProperty(android.content.pm.ServiceInfo, 'class', {
	get: function() {
...
// Allow subclassing
android.content.pm.ServiceInfo.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.content.pm.ServiceInfo.prototype);
