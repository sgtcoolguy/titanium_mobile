...
android.content.pm.ActivityInfo = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.content.pm.ActivityInfo') {
...
// class property
Object.defineProperty(android.content.pm.ActivityInfo, 'class', {
	get: function() {
...
// Allow subclassing
android.content.pm.ActivityInfo.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.content.pm.ActivityInfo.prototype);
