...
android.content.BroadcastReceiver = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.content.BroadcastReceiver') {
...
// class property
Object.defineProperty(android.content.BroadcastReceiver, 'class', {
	get: function() {
...
// Allow subclassing
android.content.BroadcastReceiver.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.content.BroadcastReceiver.prototype);
