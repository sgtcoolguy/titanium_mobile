...
java.lang.Runnable.toString = function() {
	return "[object " + this.className + "]";
};

java.lang.Runnable.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.lang.Runnable.isInstanceOf = function (self, cls) {
...
module.exports = java.lang.Runnable;
