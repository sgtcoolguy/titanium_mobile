...
android.widget.AbsListView.RecyclerListener = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.widget.AbsListView$RecyclerListener') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
// class property
Object.defineProperty(android.widget.AbsListView.RecyclerListener, 'class', {
	get: function() {
