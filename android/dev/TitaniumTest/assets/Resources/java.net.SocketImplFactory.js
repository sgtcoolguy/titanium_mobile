 ...
 **/
java.net.SocketImplFactory = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.net.SocketImplFactory') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.net.SocketImplFactory.toString = function() {
	return "[object " + this.className + "]";
};

java.net.SocketImplFactory.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.net.SocketImplFactory.isInstanceOf = function (self, cls) {
...
java.net.SocketImplFactory.className = "java.net.SocketImplFactory";
java.net.SocketImplFactory.prototype.className = "java.net.SocketImplFactory";

// Constants

// export the interface
module.exports = java.net.SocketImplFactory;
