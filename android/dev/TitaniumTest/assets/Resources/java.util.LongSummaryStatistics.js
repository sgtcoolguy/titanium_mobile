...
java.util.LongSummaryStatistics = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'java.util.LongSummaryStatistics') {
...
// class property
Object.defineProperty(java.util.LongSummaryStatistics, 'class', {
	get: function() {
...
// Allow subclassing
java.util.LongSummaryStatistics.extend = function (overrides) {
	...
	whatever.prototype = Object.create(java.util.LongSummaryStatistics.prototype);
