 ...
 **/
android.widget.AbsListView.OnScrollListener = function() {
	var result;
...
android.widget.AbsListView.OnScrollListener.toString = function() {
	return "[object " + this.className + "]";
};

android.widget.AbsListView.OnScrollListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.widget.AbsListView.OnScrollListener.isInstanceOf = function (self, cls) {
...
android.widget.AbsListView.OnScrollListener.SCROLL_STATE_IDLE = 0;
// http://developer.android.com/reference/android/widget/AbsListView.OnScrollListener.html#SCROLL_STATE_FLING
android.widget.AbsListView.OnScrollListener.SCROLL_STATE_FLING = 2;
// http://developer.android.com/reference/android/widget/AbsListView.OnScrollListener.html#SCROLL_STATE_TOUCH_SCROLL
android.widget.AbsListView.OnScrollListener.SCROLL_STATE_TOUCH_SCROLL = 1;

// export the interface
module.exports = android.widget.AbsListView.OnScrollListener;
