 ...
 **/
java.lang.Thread.State = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'java.lang.Thread$State') {
...
java.lang.Thread.State.prototype = Object.create(SuperClass.prototype);
java.lang.Thread.State.prototype.constructor = java.lang.Thread.State;

java.lang.Thread.State.className = "java.lang.Thread$State";
java.lang.Thread.State.prototype.className = "java.lang.Thread$State";

// class property
Object.defineProperty(java.lang.Thread.State, 'class', {
	get: function() {
...
Object.defineProperty(java.lang.Thread.State, 'NEW', {
	get: function() {
		...
		if (result.apiName) {
			if (result.apiName === 'java.lang.Thread$State') {
				return new java.lang.Thread.State(result);
			} else {
...
Object.defineProperty(java.lang.Thread.State, 'TERMINATED', {
	get: function() {
		var classProxy = Hyperloop.createProxy({
			class: this.className,
			alloc: false
...
Object.defineProperty(java.lang.Thread.State, 'RUNNABLE', {
	get: function() {
		var classProxy = Hyperloop.createProxy({
			class: this.className,
			alloc: false
...
Object.defineProperty(java.lang.Thread.State, 'BLOCKED', {
	get: function() {
		var classProxy = Hyperloop.createProxy({
			class: this.className,
			alloc: false
...
Object.defineProperty(java.lang.Thread.State, 'WAITING', {
	get: function() {
		var classProxy = Hyperloop.createProxy({
			class: this.className,
			alloc: false
...
Object.defineProperty(java.lang.Thread.State, 'TIMED_WAITING', {
	get: function() {
		var classProxy = Hyperloop.createProxy({
			class: this.className,
			alloc: false
 ...
 **/
java.lang.Thread.State.valueOf = function() {
 ...
 **/
java.lang.Thread.State.values = function() {
	if (!this.class) return null;
...
// export the class
module.exports = java.lang.Thread.State;
