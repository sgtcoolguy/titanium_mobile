 ...
 **/
android.view.KeyEvent.Callback = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.view.KeyEvent$Callback') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.view.KeyEvent.Callback.toString = function() {
	return "[object " + this.className + "]";
};

android.view.KeyEvent.Callback.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.KeyEvent.Callback.isInstanceOf = function (self, cls) {
...
android.view.KeyEvent.Callback.className = "android.view.KeyEvent$Callback";
android.view.KeyEvent.Callback.prototype.className = "android.view.KeyEvent$Callback";

// Constants

// export the interface
module.exports = android.view.KeyEvent.Callback;
