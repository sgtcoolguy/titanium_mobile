 ...
 **/
android.app.ActionBar.OnNavigationListener = function() {
	var result;
...
android.app.ActionBar.OnNavigationListener.toString = function() {
	return "[object " + this.className + "]";
};

android.app.ActionBar.OnNavigationListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.app.ActionBar.OnNavigationListener.isInstanceOf = function (self, cls) {
...
module.exports = android.app.ActionBar.OnNavigationListener;
