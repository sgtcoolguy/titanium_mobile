 ...
 **/
android.widget.SpinnerAdapter = function() {
	var result;
...
android.widget.SpinnerAdapter.toString = function() {
	return "[object " + this.className + "]";
};

android.widget.SpinnerAdapter.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.widget.SpinnerAdapter.isInstanceOf = function (self, cls) {
...
module.exports = android.widget.SpinnerAdapter;
