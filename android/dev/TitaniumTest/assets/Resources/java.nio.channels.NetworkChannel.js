 ...
 **/
java.nio.channels.NetworkChannel = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.nio.channels.NetworkChannel') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.nio.channels.NetworkChannel.toString = function() {
	return "[object " + this.className + "]";
};

java.nio.channels.NetworkChannel.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.nio.channels.NetworkChannel.isInstanceOf = function (self, cls) {
...
java.nio.channels.NetworkChannel.className = "java.nio.channels.NetworkChannel";
java.nio.channels.NetworkChannel.prototype.className = "java.nio.channels.NetworkChannel";

// Constants

// export the interface
module.exports = java.nio.channels.NetworkChannel;
