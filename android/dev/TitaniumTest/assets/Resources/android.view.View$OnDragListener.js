 ...
 **/
android.view.View.OnDragListener = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.view.View$OnDragListener') {
		result = arguments[0];
	}
	else {
		var instance = this,
		...
		result = Hyperloop.createProxy({
			class: 'android.view.View$OnDragListener',
			alloc: true,
			args: [modified]
		});
	}
...
android.view.View.OnDragListener.toString = function() {
	return "[object " + this.className + "]";
};

android.view.View.OnDragListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.View.OnDragListener.isInstanceOf = function (self, cls) {
...
android.view.View.OnDragListener.className = "android.view.View$OnDragListener";
android.view.View.OnDragListener.prototype.className = "android.view.View$OnDragListener";

// Constants

// export the interface
module.exports = android.view.View.OnDragListener;
