 ...
 **/
android.transition.Transition.TransitionListener = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.transition.Transition$TransitionListener') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.transition.Transition.TransitionListener.toString = function() {
	return "[object " + this.className + "]";
};

android.transition.Transition.TransitionListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.transition.Transition.TransitionListener.isInstanceOf = function (self, cls) {
...
android.transition.Transition.TransitionListener.className = "android.transition.Transition$TransitionListener";
android.transition.Transition.TransitionListener.prototype.className = "android.transition.Transition$TransitionListener";

// Constants

// export the interface
module.exports = android.transition.Transition.TransitionListener;
