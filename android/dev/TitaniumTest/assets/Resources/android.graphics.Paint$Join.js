...
android.graphics.Paint.Join = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.graphics.Paint$Join') {
...
android.graphics.Paint.Join.prototype = Object.create(SuperClass.prototype);
android.graphics.Paint.Join.prototype.constructor = android.graphics.Paint.Join;

android.graphics.Paint.Join.className = "android.graphics.Paint$Join";
android.graphics.Paint.Join.prototype.className = "android.graphics.Paint$Join";

// class property
Object.defineProperty(android.graphics.Paint.Join, 'class', {
	get: function() {
...
Object.defineProperty(android.graphics.Paint.Join, 'ROUND', {
	get: function() {
		...
		if (result.apiName) {
			if (result.apiName === 'android.graphics.Paint$Join') {
				return new android.graphics.Paint.Join(result);
			} else {
...
Object.defineProperty(android.graphics.Paint.Join, 'BEVEL', {
	get: function() {
		var classProxy = Hyperloop.createProxy({
			class: this.className,
			alloc: false
...
Object.defineProperty(android.graphics.Paint.Join, 'MITER', {
	get: function() {
		var classProxy = Hyperloop.createProxy({
			class: this.className,
			alloc: false
 ...
 **/
android.graphics.Paint.Join.valueOf = function() {
 ...
 **/
android.graphics.Paint.Join.values = function() {
	if (!this.class) return null;
...
// export the class
module.exports = android.graphics.Paint.Join;
