...
global.android.os.Parcelable = global.android.os.Parcelable || {};

/**
 * constructor
 * http://developer.android.com/reference/android/os/Parcelable.Creator.html
 **/
android.os.Parcelable.Creator = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.os.Parcelable$Creator') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.os.Parcelable.Creator.toString = function() {
	return "[object " + this.className + "]";
};

android.os.Parcelable.Creator.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.os.Parcelable.Creator.isInstanceOf = function (self, cls) {
...
android.os.Parcelable.Creator.className = "android.os.Parcelable$Creator";
android.os.Parcelable.Creator.prototype.className = "android.os.Parcelable$Creator";

// Constants

// export the interface
module.exports = android.os.Parcelable.Creator;
