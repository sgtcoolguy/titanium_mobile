...
global.android.database.sqlite.SQLiteDatabase = global.android.database.sqlite.SQLiteDatabase || {};

/**
 * constructor
 * http://developer.android.com/reference/android/database/sqlite/SQLiteDatabase.CursorFactory.html
 **/
android.database.sqlite.SQLiteDatabase.CursorFactory = function() {
	var result;
...
android.database.sqlite.SQLiteDatabase.CursorFactory.toString = function() {
	return "[object " + this.className + "]";
};

android.database.sqlite.SQLiteDatabase.CursorFactory.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.database.sqlite.SQLiteDatabase.CursorFactory.isInstanceOf = function (self, cls) {
...
module.exports = android.database.sqlite.SQLiteDatabase.CursorFactory;
