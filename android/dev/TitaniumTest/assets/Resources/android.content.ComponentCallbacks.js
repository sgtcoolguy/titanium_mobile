 ...
 **/
android.content.ComponentCallbacks = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.content.ComponentCallbacks') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.content.ComponentCallbacks.toString = function() {
	return "[object " + this.className + "]";
};

android.content.ComponentCallbacks.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.content.ComponentCallbacks.isInstanceOf = function (self, cls) {
...
android.content.ComponentCallbacks.className = "android.content.ComponentCallbacks";
android.content.ComponentCallbacks.prototype.className = "android.content.ComponentCallbacks";

// Constants

// export the interface
module.exports = android.content.ComponentCallbacks;
