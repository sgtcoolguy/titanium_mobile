...
global.android.view.ContextMenu = global.android.view.ContextMenu || {};

/**
 * constructor
 * http://developer.android.com/reference/android/view/ContextMenu.ContextMenuInfo.html
 **/
android.view.ContextMenu.ContextMenuInfo = function() {
	var result;
...
android.view.ContextMenu.ContextMenuInfo.toString = function() {
	return "[object " + this.className + "]";
};

android.view.ContextMenu.ContextMenuInfo.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.ContextMenu.ContextMenuInfo.isInstanceOf = function (self, cls) {
...
module.exports = android.view.ContextMenu.ContextMenuInfo;
