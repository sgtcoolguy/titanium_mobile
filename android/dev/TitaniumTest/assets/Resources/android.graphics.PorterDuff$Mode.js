...
android.graphics.PorterDuff.Mode = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.graphics.PorterDuff$Mode') {
...
// class property
Object.defineProperty(android.graphics.PorterDuff.Mode, 'class', {
	get: function() {
