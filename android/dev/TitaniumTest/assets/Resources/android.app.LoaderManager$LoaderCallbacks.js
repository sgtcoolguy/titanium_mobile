...
global.android.app.LoaderManager = global.android.app.LoaderManager || {};

/**
 * constructor
 * http://developer.android.com/reference/android/app/LoaderManager.LoaderCallbacks.html
 **/
android.app.LoaderManager.LoaderCallbacks = function() {
	var result;
...
android.app.LoaderManager.LoaderCallbacks.toString = function() {
	return "[object " + this.className + "]";
};

android.app.LoaderManager.LoaderCallbacks.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.app.LoaderManager.LoaderCallbacks.isInstanceOf = function (self, cls) {
...
module.exports = android.app.LoaderManager.LoaderCallbacks;
