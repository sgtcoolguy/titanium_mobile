...
java.util.function.Supplier = function() {
	...
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.function.Supplier') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.function.Supplier.toString = function() {
	return "[object " + this.className + "]";
};

java.util.function.Supplier.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.function.Supplier.isInstanceOf = function (self, cls) {
...
java.util.function.Supplier.className = "java.util.function.Supplier";
java.util.function.Supplier.prototype.className = "java.util.function.Supplier";

// Constants

// export the interface
module.exports = java.util.function.Supplier;
