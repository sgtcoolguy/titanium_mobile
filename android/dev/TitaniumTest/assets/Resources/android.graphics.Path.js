...
android.graphics.Path = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.graphics.Path') {
...
// class property
Object.defineProperty(android.graphics.Path, 'class', {
	get: function() {
...
// Allow subclassing
android.graphics.Path.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.graphics.Path.prototype);
