 ...
 **/
android.content.res.XmlResourceParser = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.content.res.XmlResourceParser') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.content.res.XmlResourceParser.toString = function() {
	return "[object " + this.className + "]";
};

android.content.res.XmlResourceParser.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.content.res.XmlResourceParser.isInstanceOf = function (self, cls) {
...
android.content.res.XmlResourceParser.className = "android.content.res.XmlResourceParser";
android.content.res.XmlResourceParser.prototype.className = "android.content.res.XmlResourceParser";

// Constants

// export the interface
module.exports = android.content.res.XmlResourceParser;
