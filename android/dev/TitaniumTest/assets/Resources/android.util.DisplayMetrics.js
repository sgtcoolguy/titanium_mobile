...
android.util.DisplayMetrics = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.util.DisplayMetrics') {
...
// class property
Object.defineProperty(android.util.DisplayMetrics, 'class', {
	get: function() {
...
// Allow subclassing
android.util.DisplayMetrics.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.util.DisplayMetrics.prototype);
