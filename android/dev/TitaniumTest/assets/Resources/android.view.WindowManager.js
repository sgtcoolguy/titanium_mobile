...
android.view.WindowManager = function() {
	...
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.view.WindowManager') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.view.WindowManager.toString = function() {
	return "[object " + this.className + "]";
};

android.view.WindowManager.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.WindowManager.isInstanceOf = function (self, cls) {
...
android.view.WindowManager.className = "android.view.WindowManager";
android.view.WindowManager.prototype.className = "android.view.WindowManager";

// Constants

// export the interface
module.exports = android.view.WindowManager;
