...
android.media.AudioAttributes = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.media.AudioAttributes') {
...
// class property
Object.defineProperty(android.media.AudioAttributes, 'class', {
	get: function() {
