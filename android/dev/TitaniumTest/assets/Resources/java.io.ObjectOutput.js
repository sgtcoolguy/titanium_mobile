 ...
 **/
java.io.ObjectOutput = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.io.ObjectOutput') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.io.ObjectOutput.toString = function() {
	return "[object " + this.className + "]";
};

java.io.ObjectOutput.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.io.ObjectOutput.isInstanceOf = function (self, cls) {
...
java.io.ObjectOutput.className = "java.io.ObjectOutput";
java.io.ObjectOutput.prototype.className = "java.io.ObjectOutput";

// Constants

// export the interface
module.exports = java.io.ObjectOutput;
