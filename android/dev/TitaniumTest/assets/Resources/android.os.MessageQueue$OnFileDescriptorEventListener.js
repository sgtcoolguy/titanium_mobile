...
global.android.os.MessageQueue = global.android.os.MessageQueue || {};

/**
 * constructor
 * http://developer.android.com/reference/android/os/MessageQueue.OnFileDescriptorEventListener.html
 **/
android.os.MessageQueue.OnFileDescriptorEventListener = function() {
	var result;
...
android.os.MessageQueue.OnFileDescriptorEventListener.toString = function() {
	return "[object " + this.className + "]";
};

android.os.MessageQueue.OnFileDescriptorEventListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.os.MessageQueue.OnFileDescriptorEventListener.isInstanceOf = function (self, cls) {
...
android.os.MessageQueue.OnFileDescriptorEventListener.EVENT_OUTPUT = 2;
// http://developer.android.com/reference/android/os/MessageQueue.OnFileDescriptorEventListener.html#EVENT_ERROR
android.os.MessageQueue.OnFileDescriptorEventListener.EVENT_ERROR = 4;
// http://developer.android.com/reference/android/os/MessageQueue.OnFileDescriptorEventListener.html#EVENT_INPUT
android.os.MessageQueue.OnFileDescriptorEventListener.EVENT_INPUT = 1;

// export the interface
module.exports = android.os.MessageQueue.OnFileDescriptorEventListener;
