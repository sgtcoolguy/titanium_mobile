 ...
 **/
android.app.FragmentManager.OnBackStackChangedListener = function() {
	var result;
...
android.app.FragmentManager.OnBackStackChangedListener.toString = function() {
	return "[object " + this.className + "]";
};

android.app.FragmentManager.OnBackStackChangedListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.app.FragmentManager.OnBackStackChangedListener.isInstanceOf = function (self, cls) {
...
module.exports = android.app.FragmentManager.OnBackStackChangedListener;
