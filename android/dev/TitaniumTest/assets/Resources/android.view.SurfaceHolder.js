 ...
 **/
android.view.SurfaceHolder = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.view.SurfaceHolder') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.view.SurfaceHolder.toString = function() {
	return "[object " + this.className + "]";
};

android.view.SurfaceHolder.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.SurfaceHolder.isInstanceOf = function (self, cls) {
...
android.view.SurfaceHolder.className = "android.view.SurfaceHolder";
android.view.SurfaceHolder.prototype.className = "android.view.SurfaceHolder";

// Constants
// http://developer.android.com/reference/android/view/SurfaceHolder.html#SURFACE_TYPE_PUSH_BUFFERS
android.view.SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS = 3;
// http://developer.android.com/reference/android/view/SurfaceHolder.html#SURFACE_TYPE_NORMAL
android.view.SurfaceHolder.SURFACE_TYPE_NORMAL = 0;
// http://developer.android.com/reference/android/view/SurfaceHolder.html#SURFACE_TYPE_GPU
android.view.SurfaceHolder.SURFACE_TYPE_GPU = 2;
// http://developer.android.com/reference/android/view/SurfaceHolder.html#SURFACE_TYPE_HARDWARE
android.view.SurfaceHolder.SURFACE_TYPE_HARDWARE = 1;

// export the interface
module.exports = android.view.SurfaceHolder;
