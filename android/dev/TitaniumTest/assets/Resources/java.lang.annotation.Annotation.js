...
global.java.lang.annotation = global.java.lang.annotation || {};

/**
 * constructor
 * http://developer.android.com/reference/java/lang/annotation/Annotation.html
 **/
java.lang.annotation.Annotation = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.lang.annotation.Annotation') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.lang.annotation.Annotation.toString = function() {
	return "[object " + this.className + "]";
};

java.lang.annotation.Annotation.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.lang.annotation.Annotation.isInstanceOf = function (self, cls) {
...
java.lang.annotation.Annotation.className = "java.lang.annotation.Annotation";
java.lang.annotation.Annotation.prototype.className = "java.lang.annotation.Annotation";

// Constants

// export the interface
module.exports = java.lang.annotation.Annotation;
