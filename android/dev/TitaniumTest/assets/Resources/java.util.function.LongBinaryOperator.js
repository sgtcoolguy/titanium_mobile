...
java.util.function.LongBinaryOperator.toString = function() {
	return "[object " + this.className + "]";
};

java.util.function.LongBinaryOperator.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.function.LongBinaryOperator.isInstanceOf = function (self, cls) {
...
module.exports = java.util.function.LongBinaryOperator;
