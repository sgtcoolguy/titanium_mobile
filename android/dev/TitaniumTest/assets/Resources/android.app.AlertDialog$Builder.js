...
android.app.AlertDialog.Builder = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.app.AlertDialog$Builder') {
...
// class property
Object.defineProperty(android.app.AlertDialog.Builder, 'class', {
	get: function() {
...
// Allow subclassing
android.app.AlertDialog.Builder.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.app.AlertDialog.Builder.prototype);
