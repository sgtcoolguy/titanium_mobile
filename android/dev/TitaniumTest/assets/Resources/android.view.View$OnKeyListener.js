 ...
 **/
android.view.View.OnKeyListener = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.view.View$OnKeyListener') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.view.View.OnKeyListener.toString = function() {
	return "[object " + this.className + "]";
};

android.view.View.OnKeyListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.View.OnKeyListener.isInstanceOf = function (self, cls) {
...
android.view.View.OnKeyListener.className = "android.view.View$OnKeyListener";
android.view.View.OnKeyListener.prototype.className = "android.view.View$OnKeyListener";

// Constants

// export the interface
module.exports = android.view.View.OnKeyListener;
