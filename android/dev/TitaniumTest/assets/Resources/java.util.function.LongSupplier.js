 ...
 **/
java.util.function.LongSupplier = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.function.LongSupplier') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.function.LongSupplier.toString = function() {
	return "[object " + this.className + "]";
};

java.util.function.LongSupplier.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.function.LongSupplier.isInstanceOf = function (self, cls) {
...
java.util.function.LongSupplier.className = "java.util.function.LongSupplier";
java.util.function.LongSupplier.prototype.className = "java.util.function.LongSupplier";

// Constants

// export the interface
module.exports = java.util.function.LongSupplier;
