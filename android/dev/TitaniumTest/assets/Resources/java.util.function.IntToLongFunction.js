...
java.util.function.IntToLongFunction = function() {
	...
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.function.IntToLongFunction') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.function.IntToLongFunction.toString = function() {
	return "[object " + this.className + "]";
};

java.util.function.IntToLongFunction.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.function.IntToLongFunction.isInstanceOf = function (self, cls) {
...
java.util.function.IntToLongFunction.className = "java.util.function.IntToLongFunction";
java.util.function.IntToLongFunction.prototype.className = "java.util.function.IntToLongFunction";

// Constants

// export the interface
module.exports = java.util.function.IntToLongFunction;
