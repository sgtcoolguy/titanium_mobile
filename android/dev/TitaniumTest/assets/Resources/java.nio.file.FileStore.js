...
java.nio.file.FileStore = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'java.nio.file.FileStore') {
...
// class property
Object.defineProperty(java.nio.file.FileStore, 'class', {
	get: function() {
...
// Allow subclassing
java.nio.file.FileStore.extend = function (overrides) {
	...
	whatever.prototype = Object.create(java.nio.file.FileStore.prototype);
