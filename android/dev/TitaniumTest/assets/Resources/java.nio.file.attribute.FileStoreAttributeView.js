 ...
 **/
java.nio.file.attribute.FileStoreAttributeView = function() {
	var result;
...
java.nio.file.attribute.FileStoreAttributeView.toString = function() {
	return "[object " + this.className + "]";
};

java.nio.file.attribute.FileStoreAttributeView.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.nio.file.attribute.FileStoreAttributeView.isInstanceOf = function (self, cls) {
...
module.exports = java.nio.file.attribute.FileStoreAttributeView;
