...
android.graphics.Paint.Align = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.graphics.Paint$Align') {
...
// class property
Object.defineProperty(android.graphics.Paint.Align, 'class', {
	get: function() {
