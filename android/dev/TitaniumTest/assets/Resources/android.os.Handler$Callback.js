...
global.android.os.Handler = global.android.os.Handler || {};

/**
 * constructor
 * http://developer.android.com/reference/android/os/Handler.Callback.html
 **/
android.os.Handler.Callback = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.os.Handler$Callback') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.os.Handler.Callback.toString = function() {
	return "[object " + this.className + "]";
};

android.os.Handler.Callback.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.os.Handler.Callback.isInstanceOf = function (self, cls) {
...
android.os.Handler.Callback.className = "android.os.Handler$Callback";
android.os.Handler.Callback.prototype.className = "android.os.Handler$Callback";

// Constants

// export the interface
module.exports = android.os.Handler.Callback;
