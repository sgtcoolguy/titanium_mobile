...
java.lang.Iterable.toString = function() {
	return "[object " + this.className + "]";
};

java.lang.Iterable.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.lang.Iterable.isInstanceOf = function (self, cls) {
...
module.exports = java.lang.Iterable;
