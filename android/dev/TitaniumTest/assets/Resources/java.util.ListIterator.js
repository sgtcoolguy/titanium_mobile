 ...
 **/
java.util.ListIterator = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.ListIterator') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.ListIterator.toString = function() {
	return "[object " + this.className + "]";
};

java.util.ListIterator.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.ListIterator.isInstanceOf = function (self, cls) {
...
java.util.ListIterator.className = "java.util.ListIterator";
java.util.ListIterator.prototype.className = "java.util.ListIterator";

// Constants

// export the interface
module.exports = java.util.ListIterator;
