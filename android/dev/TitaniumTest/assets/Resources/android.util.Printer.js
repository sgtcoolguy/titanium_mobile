 ...
 **/
android.util.Printer = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.util.Printer') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.util.Printer.toString = function() {
	return "[object " + this.className + "]";
};

android.util.Printer.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.util.Printer.isInstanceOf = function (self, cls) {
...
android.util.Printer.className = "android.util.Printer";
android.util.Printer.prototype.className = "android.util.Printer";

// Constants

// export the interface
module.exports = android.util.Printer;
