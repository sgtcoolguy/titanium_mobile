 ...
 **/
java.nio.channels.Channel = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.nio.channels.Channel') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.nio.channels.Channel.toString = function() {
	return "[object " + this.className + "]";
};

java.nio.channels.Channel.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.nio.channels.Channel.isInstanceOf = function (self, cls) {
...
java.nio.channels.Channel.className = "java.nio.channels.Channel";
java.nio.channels.Channel.prototype.className = "java.nio.channels.Channel";

// Constants

// export the interface
module.exports = java.nio.channels.Channel;
