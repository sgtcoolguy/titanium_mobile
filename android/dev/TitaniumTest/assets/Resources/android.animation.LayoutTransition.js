...
android.animation.LayoutTransition = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.animation.LayoutTransition') {
...
// class property
Object.defineProperty(android.animation.LayoutTransition, 'class', {
	get: function() {
...
// Allow subclassing
android.animation.LayoutTransition.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.animation.LayoutTransition.prototype);
