 ...
 **/
android.database.sqlite.SQLiteTransactionListener = function() {
	var result;
...
android.database.sqlite.SQLiteTransactionListener.toString = function() {
	return "[object " + this.className + "]";
};

android.database.sqlite.SQLiteTransactionListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.database.sqlite.SQLiteTransactionListener.isInstanceOf = function (self, cls) {
...
module.exports = android.database.sqlite.SQLiteTransactionListener;
