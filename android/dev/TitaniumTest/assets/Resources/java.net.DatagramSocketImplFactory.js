 ...
 **/
java.net.DatagramSocketImplFactory = function() {
	var result;
...
java.net.DatagramSocketImplFactory.toString = function() {
	return "[object " + this.className + "]";
};

java.net.DatagramSocketImplFactory.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.net.DatagramSocketImplFactory.isInstanceOf = function (self, cls) {
...
module.exports = java.net.DatagramSocketImplFactory;
