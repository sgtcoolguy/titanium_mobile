 ...
 **/
java.io.Closeable = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.io.Closeable') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.io.Closeable.toString = function() {
	return "[object " + this.className + "]";
};

java.io.Closeable.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.io.Closeable.isInstanceOf = function (self, cls) {
...
java.io.Closeable.className = "java.io.Closeable";
java.io.Closeable.prototype.className = "java.io.Closeable";

// Constants

// export the interface
module.exports = java.io.Closeable;
