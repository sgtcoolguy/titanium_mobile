 ...
 **/
android.os.Parcelable = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.os.Parcelable') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.os.Parcelable.toString = function() {
	return "[object " + this.className + "]";
};

android.os.Parcelable.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.os.Parcelable.isInstanceOf = function (self, cls) {
...
android.os.Parcelable.className = "android.os.Parcelable";
android.os.Parcelable.prototype.className = "android.os.Parcelable";

// Constants
// http://developer.android.com/reference/android/os/Parcelable.html#PARCELABLE_WRITE_RETURN_VALUE
android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE = 1;
// http://developer.android.com/reference/android/os/Parcelable.html#CONTENTS_FILE_DESCRIPTOR
android.os.Parcelable.CONTENTS_FILE_DESCRIPTOR = 1;

// export the interface
module.exports = android.os.Parcelable;
