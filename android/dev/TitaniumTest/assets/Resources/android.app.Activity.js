...
android.app.Activity = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.app.Activity') {
...
// class property
Object.defineProperty(android.app.Activity, 'class', {
	get: function() {
...
// Allow subclassing
android.app.Activity.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.app.Activity.prototype);
