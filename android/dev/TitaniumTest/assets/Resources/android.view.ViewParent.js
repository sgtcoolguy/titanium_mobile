 ...
 **/
android.view.ViewParent = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.view.ViewParent') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.view.ViewParent.toString = function() {
	return "[object " + this.className + "]";
};

android.view.ViewParent.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.ViewParent.isInstanceOf = function (self, cls) {
...
android.view.ViewParent.className = "android.view.ViewParent";
android.view.ViewParent.prototype.className = "android.view.ViewParent";

// Constants

// export the interface
module.exports = android.view.ViewParent;
