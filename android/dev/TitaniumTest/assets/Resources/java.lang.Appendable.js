 ...
 **/
java.lang.Appendable = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.lang.Appendable') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.lang.Appendable.toString = function() {
	return "[object " + this.className + "]";
};

java.lang.Appendable.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.lang.Appendable.isInstanceOf = function (self, cls) {
...
java.lang.Appendable.className = "java.lang.Appendable";
java.lang.Appendable.prototype.className = "java.lang.Appendable";

// Constants

// export the interface
module.exports = java.lang.Appendable;
