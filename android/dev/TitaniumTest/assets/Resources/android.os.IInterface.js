 ...
 **/
android.os.IInterface = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.os.IInterface') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.os.IInterface.toString = function() {
	return "[object " + this.className + "]";
};

android.os.IInterface.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.os.IInterface.isInstanceOf = function (self, cls) {
...
android.os.IInterface.className = "android.os.IInterface";
android.os.IInterface.prototype.className = "android.os.IInterface";

// Constants

// export the interface
module.exports = android.os.IInterface;
