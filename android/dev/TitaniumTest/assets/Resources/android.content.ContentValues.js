...
android.content.ContentValues = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.content.ContentValues') {
...
// class property
Object.defineProperty(android.content.ContentValues, 'class', {
	get: function() {
