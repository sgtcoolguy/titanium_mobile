 ...
 **/
java.util.Enumeration = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.Enumeration') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.Enumeration.toString = function() {
	return "[object " + this.className + "]";
};

java.util.Enumeration.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.Enumeration.isInstanceOf = function (self, cls) {
...
java.util.Enumeration.className = "java.util.Enumeration";
java.util.Enumeration.prototype.className = "java.util.Enumeration";

// Constants

// export the interface
module.exports = java.util.Enumeration;
