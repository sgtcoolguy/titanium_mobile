...
global.android.os.IBinder = global.android.os.IBinder || {};

/**
 * constructor
 * http://developer.android.com/reference/android/os/IBinder.DeathRecipient.html
 **/
android.os.IBinder.DeathRecipient = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.os.IBinder$DeathRecipient') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.os.IBinder.DeathRecipient.toString = function() {
	return "[object " + this.className + "]";
};

android.os.IBinder.DeathRecipient.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.os.IBinder.DeathRecipient.isInstanceOf = function (self, cls) {
...
android.os.IBinder.DeathRecipient.className = "android.os.IBinder$DeathRecipient";
android.os.IBinder.DeathRecipient.prototype.className = "android.os.IBinder$DeathRecipient";

// Constants

// export the interface
module.exports = android.os.IBinder.DeathRecipient;
