...
android.content.IntentFilter.AuthorityEntry = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.content.IntentFilter$AuthorityEntry') {
...
// class property
Object.defineProperty(android.content.IntentFilter.AuthorityEntry, 'class', {
	get: function() {
