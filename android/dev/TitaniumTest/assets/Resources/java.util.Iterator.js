...
java.util.Iterator = function() {
	...
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.Iterator') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.Iterator.toString = function() {
	return "[object " + this.className + "]";
};

java.util.Iterator.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.Iterator.isInstanceOf = function (self, cls) {
...
java.util.Iterator.className = "java.util.Iterator";
java.util.Iterator.prototype.className = "java.util.Iterator";

// Constants

// export the interface
module.exports = java.util.Iterator;
