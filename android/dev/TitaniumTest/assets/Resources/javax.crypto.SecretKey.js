 ...
 **/
javax.crypto.SecretKey = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'javax.crypto.SecretKey') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
javax.crypto.SecretKey.toString = function() {
	return "[object " + this.className + "]";
};

javax.crypto.SecretKey.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
javax.crypto.SecretKey.isInstanceOf = function (self, cls) {
...
javax.crypto.SecretKey.className = "javax.crypto.SecretKey";
javax.crypto.SecretKey.prototype.className = "javax.crypto.SecretKey";

// class property
Object.defineProperty(javax.crypto.SecretKey, 'class', {
	get: function() {
...
// Constants
// http://developer.android.com/reference/javax/crypto/SecretKey.html#serialVersionUID
javax.crypto.SecretKey.serialVersionUID = -4795878709595146952;

// export the interface
module.exports = javax.crypto.SecretKey;
