...
android.graphics.Region = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.graphics.Region') {
...
// class property
Object.defineProperty(android.graphics.Region, 'class', {
	get: function() {
...
// Allow subclassing
android.graphics.Region.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.graphics.Region.prototype);
