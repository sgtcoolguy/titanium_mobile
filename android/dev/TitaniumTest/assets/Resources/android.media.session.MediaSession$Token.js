...
android.media.session.MediaSession.Token = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.media.session.MediaSession$Token') {
...
// class property
Object.defineProperty(android.media.session.MediaSession.Token, 'class', {
	get: function() {
