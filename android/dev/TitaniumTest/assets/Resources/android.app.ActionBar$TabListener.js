 ...
 **/
android.app.ActionBar.TabListener = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.app.ActionBar$TabListener') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.app.ActionBar.TabListener.toString = function() {
	return "[object " + this.className + "]";
};

android.app.ActionBar.TabListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.app.ActionBar.TabListener.isInstanceOf = function (self, cls) {
...
android.app.ActionBar.TabListener.className = "android.app.ActionBar$TabListener";
android.app.ActionBar.TabListener.prototype.className = "android.app.ActionBar$TabListener";

// Constants

// export the interface
module.exports = android.app.ActionBar.TabListener;
