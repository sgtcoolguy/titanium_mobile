...
global.android.animation.ValueAnimator = global.android.animation.ValueAnimator || {};

/**
 * constructor
 * http://developer.android.com/reference/android/animation/ValueAnimator.AnimatorUpdateListener.html
 **/
android.animation.ValueAnimator.AnimatorUpdateListener = function() {
	var result;
...
android.animation.ValueAnimator.AnimatorUpdateListener.toString = function() {
	return "[object " + this.className + "]";
};

android.animation.ValueAnimator.AnimatorUpdateListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.animation.ValueAnimator.AnimatorUpdateListener.isInstanceOf = function (self, cls) {
...
module.exports = android.animation.ValueAnimator.AnimatorUpdateListener;
