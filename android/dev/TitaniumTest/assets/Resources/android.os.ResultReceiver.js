...
android.os.ResultReceiver = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.os.ResultReceiver') {
...
// class property
Object.defineProperty(android.os.ResultReceiver, 'class', {
	get: function() {
...
// Allow subclassing
android.os.ResultReceiver.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.os.ResultReceiver.prototype);
