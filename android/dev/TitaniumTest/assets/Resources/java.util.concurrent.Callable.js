 ...
 **/
java.util.concurrent.Callable = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.concurrent.Callable') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.concurrent.Callable.toString = function() {
	return "[object " + this.className + "]";
};

java.util.concurrent.Callable.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.concurrent.Callable.isInstanceOf = function (self, cls) {
...
java.util.concurrent.Callable.className = "java.util.concurrent.Callable";
java.util.concurrent.Callable.prototype.className = "java.util.concurrent.Callable";

// Constants

// export the interface
module.exports = java.util.concurrent.Callable;
