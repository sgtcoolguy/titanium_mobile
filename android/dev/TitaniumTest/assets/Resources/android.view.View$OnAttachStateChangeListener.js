 ...
 **/
android.view.View.OnAttachStateChangeListener = function() {
	var result;
...
android.view.View.OnAttachStateChangeListener.toString = function() {
	return "[object " + this.className + "]";
};

android.view.View.OnAttachStateChangeListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.View.OnAttachStateChangeListener.isInstanceOf = function (self, cls) {
...
module.exports = android.view.View.OnAttachStateChangeListener;
