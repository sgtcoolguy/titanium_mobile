 ...
 **/
android.text.TextWatcher = function() {
	var result;
...
android.text.TextWatcher.toString = function() {
	return "[object " + this.className + "]";
};

android.text.TextWatcher.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.text.TextWatcher.isInstanceOf = function (self, cls) {
...
module.exports = android.text.TextWatcher;
