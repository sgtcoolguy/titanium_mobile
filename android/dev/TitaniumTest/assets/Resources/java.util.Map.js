...
java.util.Map = function() {
	...
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.Map') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.Map.toString = function() {
	return "[object " + this.className + "]";
};

java.util.Map.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.Map.isInstanceOf = function (self, cls) {
...
java.util.Map.className = "java.util.Map";
java.util.Map.prototype.className = "java.util.Map";

// Constants

// export the interface
module.exports = java.util.Map;
