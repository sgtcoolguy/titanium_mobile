 ...
 **/
android.util.Property = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.util.Property') {
...
android.util.Property.prototype = Object.create(SuperClass.prototype);
android.util.Property.prototype.constructor = android.util.Property;

android.util.Property.className = "android.util.Property";
android.util.Property.prototype.className = "android.util.Property";

// class property
Object.defineProperty(android.util.Property, 'class', {
	get: function() {
...
// Allow subclassing
android.util.Property.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.util.Property.prototype);
 ...
 **/
android.util.Property.of = function() {
	...
	if (result.apiName) {
		if (result.apiName === 'android.util.Property') {
			return new android.util.Property(result);
		} else {
 ...
 **/
android.util.Property.prototype.isReadOnly = function() {
 ...
 **/
android.util.Property.prototype.set = function() {
	if (!this._hasPointer) return null;
 ...
 **/
android.util.Property.prototype.getName = function() {
	if (!this._hasPointer) return null;
 ...
 **/
android.util.Property.prototype.getType = function() {
	if (!this._hasPointer) return null;
 ...
 **/
android.util.Property.prototype.get = function() {
	if (!this._hasPointer) return null;
...
// export the class
module.exports = android.util.Property;
