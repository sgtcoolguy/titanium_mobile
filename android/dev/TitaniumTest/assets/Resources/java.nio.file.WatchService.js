 ...
 **/
java.nio.file.WatchService = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.nio.file.WatchService') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.nio.file.WatchService.toString = function() {
	return "[object " + this.className + "]";
};

java.nio.file.WatchService.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.nio.file.WatchService.isInstanceOf = function (self, cls) {
...
java.nio.file.WatchService.className = "java.nio.file.WatchService";
java.nio.file.WatchService.prototype.className = "java.nio.file.WatchService";

// Constants

// export the interface
module.exports = java.nio.file.WatchService;
