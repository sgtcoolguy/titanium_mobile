...
java.util.Collection = function() {
	...
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.Collection') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.Collection.toString = function() {
	return "[object " + this.className + "]";
};

java.util.Collection.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.Collection.isInstanceOf = function (self, cls) {
...
java.util.Collection.className = "java.util.Collection";
java.util.Collection.prototype.className = "java.util.Collection";

// Constants

// export the interface
module.exports = java.util.Collection;
