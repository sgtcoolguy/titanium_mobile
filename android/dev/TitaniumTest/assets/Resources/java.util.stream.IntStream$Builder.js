...
global.java.util.stream.IntStream = global.java.util.stream.IntStream || {};

/**
 * constructor
 * http://developer.android.com/reference/java/util/stream/IntStream.Builder.html
 **/
java.util.stream.IntStream.Builder = function() {
	var result;
...
java.util.stream.IntStream.Builder.toString = function() {
	return "[object " + this.className + "]";
};

java.util.stream.IntStream.Builder.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.stream.IntStream.Builder.isInstanceOf = function (self, cls) {
...
module.exports = java.util.stream.IntStream.Builder;
