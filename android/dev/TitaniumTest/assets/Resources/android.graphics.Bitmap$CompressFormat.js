...
global.android.graphics.Bitmap = global.android.graphics.Bitmap || {};
 ...
 **/
android.graphics.Bitmap.CompressFormat = function() {
	var result;
...
android.graphics.Bitmap.CompressFormat.prototype = Object.create(SuperClass.prototype);
android.graphics.Bitmap.CompressFormat.prototype.constructor = android.graphics.Bitmap.CompressFormat;
...
Object.defineProperty(android.graphics.Bitmap.CompressFormat, 'WEBP', {
	get: function() {
		...
		if (result.apiName) {
			if (result.apiName === 'android.graphics.Bitmap$CompressFormat') {
				return new android.graphics.Bitmap.CompressFormat(result);
			} else {
...
Object.defineProperty(android.graphics.Bitmap.CompressFormat, 'PNG', {
	get: function() {
		var classProxy = Hyperloop.createProxy({
			class: this.className,
			alloc: false
...
Object.defineProperty(android.graphics.Bitmap.CompressFormat, 'JPEG', {
	get: function() {
		var classProxy = Hyperloop.createProxy({
			class: this.className,
			alloc: false
...
// export the class
module.exports = android.graphics.Bitmap.CompressFormat;
