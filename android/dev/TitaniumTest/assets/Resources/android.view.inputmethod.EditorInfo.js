...
android.view.inputmethod.EditorInfo = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.view.inputmethod.EditorInfo') {
...
// class property
Object.defineProperty(android.view.inputmethod.EditorInfo, 'class', {
	get: function() {
...
// Allow subclassing
android.view.inputmethod.EditorInfo.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.view.inputmethod.EditorInfo.prototype);
