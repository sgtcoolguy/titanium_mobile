...
android.os.Handler = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.os.Handler') {
...
// class property
Object.defineProperty(android.os.Handler, 'class', {
	get: function() {
...
// Allow subclassing
android.os.Handler.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.os.Handler.prototype);
