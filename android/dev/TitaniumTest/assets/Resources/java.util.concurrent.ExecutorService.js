 ...
 **/
java.util.concurrent.ExecutorService = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.concurrent.ExecutorService') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.concurrent.ExecutorService.toString = function() {
	return "[object " + this.className + "]";
};

java.util.concurrent.ExecutorService.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.concurrent.ExecutorService.isInstanceOf = function (self, cls) {
...
java.util.concurrent.ExecutorService.className = "java.util.concurrent.ExecutorService";
java.util.concurrent.ExecutorService.prototype.className = "java.util.concurrent.ExecutorService";

// Constants

// export the interface
module.exports = java.util.concurrent.ExecutorService;
