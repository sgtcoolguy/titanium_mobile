...
android.content.ContextWrapper = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.content.ContextWrapper') {
...
// class property
Object.defineProperty(android.content.ContextWrapper, 'class', {
	get: function() {
...
// Allow subclassing
android.content.ContextWrapper.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.content.ContextWrapper.prototype);
