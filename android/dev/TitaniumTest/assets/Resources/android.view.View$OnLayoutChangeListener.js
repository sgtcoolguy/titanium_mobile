 ...
 **/
android.view.View.OnLayoutChangeListener = function() {
	var result;
...
android.view.View.OnLayoutChangeListener.toString = function() {
	return "[object " + this.className + "]";
};

android.view.View.OnLayoutChangeListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.View.OnLayoutChangeListener.isInstanceOf = function (self, cls) {
...
module.exports = android.view.View.OnLayoutChangeListener;
