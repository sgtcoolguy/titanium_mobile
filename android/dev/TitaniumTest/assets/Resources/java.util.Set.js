...
java.util.Set = function() {
	...
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.Set') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.Set.toString = function() {
	return "[object " + this.className + "]";
};

java.util.Set.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.Set.isInstanceOf = function (self, cls) {
...
java.util.Set.className = "java.util.Set";
java.util.Set.prototype.className = "java.util.Set";

// Constants

// export the interface
module.exports = java.util.Set;
