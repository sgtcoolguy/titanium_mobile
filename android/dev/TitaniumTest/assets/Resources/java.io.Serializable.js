...
java.io.Serializable = function() {
	...
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.io.Serializable') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.io.Serializable.toString = function() {
	return "[object " + this.className + "]";
};

java.io.Serializable.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.io.Serializable.isInstanceOf = function (self, cls) {
...
java.io.Serializable.className = "java.io.Serializable";
java.io.Serializable.prototype.className = "java.io.Serializable";

// Constants

// export the interface
module.exports = java.io.Serializable;
