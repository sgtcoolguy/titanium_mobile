...
android.database.sqlite.SQLiteProgram = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.database.sqlite.SQLiteProgram') {
...
// class property
Object.defineProperty(android.database.sqlite.SQLiteProgram, 'class', {
	get: function() {
...
// Allow subclassing
android.database.sqlite.SQLiteProgram.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.database.sqlite.SQLiteProgram.prototype);
