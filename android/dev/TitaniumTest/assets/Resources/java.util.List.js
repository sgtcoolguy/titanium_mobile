...
java.util.List = function() {
	...
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.List') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.List.toString = function() {
	return "[object " + this.className + "]";
};

java.util.List.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.List.isInstanceOf = function (self, cls) {
...
java.util.List.className = "java.util.List";
java.util.List.prototype.className = "java.util.List";

// Constants

// export the interface
module.exports = java.util.List;
