 ...
 **/
android.widget.ListAdapter = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'android.widget.ListAdapter') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.widget.ListAdapter.toString = function() {
	return "[object " + this.className + "]";
};

android.widget.ListAdapter.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.widget.ListAdapter.isInstanceOf = function (self, cls) {
...
android.widget.ListAdapter.className = "android.widget.ListAdapter";
android.widget.ListAdapter.prototype.className = "android.widget.ListAdapter";

// class property
Object.defineProperty(android.widget.ListAdapter, 'class', {
	get: function() {
...
module.exports = android.widget.ListAdapter;
