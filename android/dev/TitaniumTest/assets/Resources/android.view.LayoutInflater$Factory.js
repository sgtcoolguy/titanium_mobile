 ...
 **/
android.view.LayoutInflater.Factory = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.view.LayoutInflater$Factory') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.view.LayoutInflater.Factory.toString = function() {
	return "[object " + this.className + "]";
};

android.view.LayoutInflater.Factory.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.LayoutInflater.Factory.isInstanceOf = function (self, cls) {
...
android.view.LayoutInflater.Factory.className = "android.view.LayoutInflater$Factory";
android.view.LayoutInflater.Factory.prototype.className = "android.view.LayoutInflater$Factory";

// Constants

// export the interface
module.exports = android.view.LayoutInflater.Factory;
