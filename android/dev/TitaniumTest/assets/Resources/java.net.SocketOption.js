 ...
 **/
java.net.SocketOption = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.net.SocketOption') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.net.SocketOption.toString = function() {
	return "[object " + this.className + "]";
};

java.net.SocketOption.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.net.SocketOption.isInstanceOf = function (self, cls) {
...
java.net.SocketOption.className = "java.net.SocketOption";
java.net.SocketOption.prototype.className = "java.net.SocketOption";

// Constants

// export the interface
module.exports = java.net.SocketOption;
