 ...
 **/
java.security.KeyStore.Entry = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.security.KeyStore$Entry') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.security.KeyStore.Entry.toString = function() {
	return "[object " + this.className + "]";
};

java.security.KeyStore.Entry.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.security.KeyStore.Entry.isInstanceOf = function (self, cls) {
...
java.security.KeyStore.Entry.className = "java.security.KeyStore$Entry";
java.security.KeyStore.Entry.prototype.className = "java.security.KeyStore$Entry";

// class property
Object.defineProperty(java.security.KeyStore.Entry, 'class', {
	get: function() {
...
module.exports = java.security.KeyStore.Entry;
