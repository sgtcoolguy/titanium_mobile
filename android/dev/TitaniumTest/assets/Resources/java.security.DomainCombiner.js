 ...
 **/
java.security.DomainCombiner = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.security.DomainCombiner') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.security.DomainCombiner.toString = function() {
	return "[object " + this.className + "]";
};

java.security.DomainCombiner.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.security.DomainCombiner.isInstanceOf = function (self, cls) {
...
java.security.DomainCombiner.className = "java.security.DomainCombiner";
java.security.DomainCombiner.prototype.className = "java.security.DomainCombiner";

// Constants

// export the interface
module.exports = java.security.DomainCombiner;
