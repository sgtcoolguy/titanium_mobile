...
java.util.function.IntFunction.toString = function() {
	return "[object " + this.className + "]";
};

java.util.function.IntFunction.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.function.IntFunction.isInstanceOf = function (self, cls) {
...
module.exports = java.util.function.IntFunction;
