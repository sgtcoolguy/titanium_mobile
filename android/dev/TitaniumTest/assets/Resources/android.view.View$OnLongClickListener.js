 ...
 **/
android.view.View.OnLongClickListener = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.view.View$OnLongClickListener') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.view.View.OnLongClickListener.toString = function() {
	return "[object " + this.className + "]";
};

android.view.View.OnLongClickListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.View.OnLongClickListener.isInstanceOf = function (self, cls) {
...
android.view.View.OnLongClickListener.className = "android.view.View$OnLongClickListener";
android.view.View.OnLongClickListener.prototype.className = "android.view.View$OnLongClickListener";

// Constants

// export the interface
module.exports = android.view.View.OnLongClickListener;
