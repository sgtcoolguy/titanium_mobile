 ...
 **/
java.io.ObjectInputValidation = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.io.ObjectInputValidation') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.io.ObjectInputValidation.toString = function() {
	return "[object " + this.className + "]";
};

java.io.ObjectInputValidation.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.io.ObjectInputValidation.isInstanceOf = function (self, cls) {
...
java.io.ObjectInputValidation.className = "java.io.ObjectInputValidation";
java.io.ObjectInputValidation.prototype.className = "java.io.ObjectInputValidation";

// Constants

// export the interface
module.exports = java.io.ObjectInputValidation;
