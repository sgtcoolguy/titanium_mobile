...
android.animation.Animator = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.animation.Animator') {
...
// class property
Object.defineProperty(android.animation.Animator, 'class', {
	get: function() {
...
// Allow subclassing
android.animation.Animator.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.animation.Animator.prototype);
