 ...
 **/
android.os.Parcelable.ClassLoaderCreator = function() {
	var result;
...
android.os.Parcelable.ClassLoaderCreator.toString = function() {
	return "[object " + this.className + "]";
};

android.os.Parcelable.ClassLoaderCreator.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.os.Parcelable.ClassLoaderCreator.isInstanceOf = function (self, cls) {
...
module.exports = android.os.Parcelable.ClassLoaderCreator;
