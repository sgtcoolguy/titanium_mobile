 ...
 **/
android.app.ActionBar.OnMenuVisibilityListener = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.app.ActionBar$OnMenuVisibilityListener') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.app.ActionBar.OnMenuVisibilityListener.toString = function() {
	return "[object " + this.className + "]";
};

android.app.ActionBar.OnMenuVisibilityListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.app.ActionBar.OnMenuVisibilityListener.isInstanceOf = function (self, cls) {
...
android.app.ActionBar.OnMenuVisibilityListener.className = "android.app.ActionBar$OnMenuVisibilityListener";
android.app.ActionBar.OnMenuVisibilityListener.prototype.className = "android.app.ActionBar$OnMenuVisibilityListener";

// Constants

// export the interface
module.exports = android.app.ActionBar.OnMenuVisibilityListener;
