...
android.view.View.AccessibilityDelegate = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.view.View$AccessibilityDelegate') {
...
// class property
Object.defineProperty(android.view.View.AccessibilityDelegate, 'class', {
	get: function() {
...
// Allow subclassing
android.view.View.AccessibilityDelegate.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.view.View.AccessibilityDelegate.prototype);
