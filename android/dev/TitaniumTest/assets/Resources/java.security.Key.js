 ...
 **/
java.security.Key = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName && arguments[0].apiName === 'java.security.Key') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.security.Key.toString = function() {
	return "[object " + this.className + "]";
};

java.security.Key.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.security.Key.isInstanceOf = function (self, cls) {
...
java.security.Key.className = "java.security.Key";
java.security.Key.prototype.className = "java.security.Key";

// class property
Object.defineProperty(java.security.Key, 'class', {
	get: function() {
...
// Constants
// http://developer.android.com/reference/java/security/Key.html#serialVersionUID
java.security.Key.serialVersionUID = 6603384152749567654;

// export the interface
module.exports = java.security.Key;
