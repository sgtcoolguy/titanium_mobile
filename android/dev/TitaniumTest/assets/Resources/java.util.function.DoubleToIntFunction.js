...
java.util.function.DoubleToIntFunction = function() {
	...
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.util.function.DoubleToIntFunction') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.util.function.DoubleToIntFunction.toString = function() {
	return "[object " + this.className + "]";
};

java.util.function.DoubleToIntFunction.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.util.function.DoubleToIntFunction.isInstanceOf = function (self, cls) {
...
java.util.function.DoubleToIntFunction.className = "java.util.function.DoubleToIntFunction";
java.util.function.DoubleToIntFunction.prototype.className = "java.util.function.DoubleToIntFunction";

// Constants

// export the interface
module.exports = java.util.function.DoubleToIntFunction;
