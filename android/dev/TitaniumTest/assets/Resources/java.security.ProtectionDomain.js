...
java.security.ProtectionDomain = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'java.security.ProtectionDomain') {
...
// class property
Object.defineProperty(java.security.ProtectionDomain, 'class', {
	get: function() {
...
// Allow subclassing
java.security.ProtectionDomain.extend = function (overrides) {
	...
	whatever.prototype = Object.create(java.security.ProtectionDomain.prototype);
