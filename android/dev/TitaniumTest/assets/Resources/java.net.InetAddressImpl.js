...
/**
 * constructor
 * http://developer.android.com/reference/java/net/InetAddressImpl.html
 **/
java.net.InetAddressImpl = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'java.net.InetAddressImpl') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
java.net.InetAddressImpl.toString = function() {
	return "[object " + this.className + "]";
};

java.net.InetAddressImpl.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.net.InetAddressImpl.isInstanceOf = function (self, cls) {
...
java.net.InetAddressImpl.className = "java.net.InetAddressImpl";
java.net.InetAddressImpl.prototype.className = "java.net.InetAddressImpl";

// Constants

// export the interface
module.exports = java.net.InetAddressImpl;
