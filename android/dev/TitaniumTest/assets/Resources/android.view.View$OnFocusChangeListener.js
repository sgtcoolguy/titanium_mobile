 ...
 **/
android.view.View.OnFocusChangeListener = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.view.View$OnFocusChangeListener') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.view.View.OnFocusChangeListener.toString = function() {
	return "[object " + this.className + "]";
};

android.view.View.OnFocusChangeListener.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.View.OnFocusChangeListener.isInstanceOf = function (self, cls) {
...
android.view.View.OnFocusChangeListener.className = "android.view.View$OnFocusChangeListener";
android.view.View.OnFocusChangeListener.prototype.className = "android.view.View$OnFocusChangeListener";

// Constants

// export the interface
module.exports = android.view.View.OnFocusChangeListener;
