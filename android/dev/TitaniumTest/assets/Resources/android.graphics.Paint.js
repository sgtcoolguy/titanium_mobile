...
android.graphics.Paint = function() {
	...
	if (arguments.length == 1 && arguments[0].isNativeProxy && arguments[0].apiName === 'android.graphics.Paint') {
...
// class property
Object.defineProperty(android.graphics.Paint, 'class', {
	get: function() {
...
// Allow subclassing
android.graphics.Paint.extend = function (overrides) {
	...
	whatever.prototype = Object.create(android.graphics.Paint.prototype);
