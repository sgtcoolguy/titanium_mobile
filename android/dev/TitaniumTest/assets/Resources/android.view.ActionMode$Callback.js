...
global.android.view.ActionMode = global.android.view.ActionMode || {};

/**
 * constructor
 * http://developer.android.com/reference/android/view/ActionMode.Callback.html
 **/
android.view.ActionMode.Callback = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.view.ActionMode$Callback') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.view.ActionMode.Callback.toString = function() {
	return "[object " + this.className + "]";
};

android.view.ActionMode.Callback.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.view.ActionMode.Callback.isInstanceOf = function (self, cls) {
...
android.view.ActionMode.Callback.className = "android.view.ActionMode$Callback";
android.view.ActionMode.Callback.prototype.className = "android.view.ActionMode$Callback";

// Constants

// export the interface
module.exports = android.view.ActionMode.Callback;
