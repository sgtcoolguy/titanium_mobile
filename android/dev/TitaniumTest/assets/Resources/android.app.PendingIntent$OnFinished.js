...
global.android.app.PendingIntent = global.android.app.PendingIntent || {};

/**
 * constructor
 * http://developer.android.com/reference/android/app/PendingIntent.OnFinished.html
 **/
android.app.PendingIntent.OnFinished = function() {
	var result;
	// Allow the constructor to either invoke the real java constructor, or function as a "wrapping" method that will take
	// a single argument that is a native hyperloop proxy for this class type and just wraps it in our JS type.
	if (arguments.length == 1 && arguments[0].apiName && arguments[0].apiName === 'android.app.PendingIntent$OnFinished') {
		result = arguments[0];
	}
	else {
		var instance = this,
...
android.app.PendingIntent.OnFinished.toString = function() {
	return "[object " + this.className + "]";
};

android.app.PendingIntent.OnFinished.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
android.app.PendingIntent.OnFinished.isInstanceOf = function (self, cls) {
...
android.app.PendingIntent.OnFinished.className = "android.app.PendingIntent$OnFinished";
android.app.PendingIntent.OnFinished.prototype.className = "android.app.PendingIntent$OnFinished";

// Constants

// export the interface
module.exports = android.app.PendingIntent.OnFinished;
