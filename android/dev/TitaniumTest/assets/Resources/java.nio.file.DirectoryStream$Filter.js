...
global.java.nio.file.DirectoryStream = global.java.nio.file.DirectoryStream || {};

/**
 * constructor
 * http://developer.android.com/reference/java/nio/file/DirectoryStream.Filter.html
 **/
java.nio.file.DirectoryStream.Filter = function() {
	var result;
...
java.nio.file.DirectoryStream.Filter.toString = function() {
	return "[object " + this.className + "]";
};

java.nio.file.DirectoryStream.Filter.prototype.toString = function() {
	if (this._hasPointer) {
		return "[object " + this.className + "]";
	}
	return null;
...
java.nio.file.DirectoryStream.Filter.isInstanceOf = function (self, cls) {
...
module.exports = java.nio.file.DirectoryStream.Filter;
